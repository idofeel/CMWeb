...
class CMView extends Component<Props, State> {
        ...
        return (
            <div className="CMWebContainer">
                <div className="CMTools">
                    <Switch className="uiContainer" checkedChildren="显示" unCheckedChildren="隐藏" onChange={(checked) => {
    ...
    componentDidMount() {
        CMWeb.Init3DViewer(this.state.initType);
        // this.ShowUI()
