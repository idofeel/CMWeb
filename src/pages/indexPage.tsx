...
import "../@types"
import DrawerCate from "./admin/categorys/drawerCate"
...
class IndexPage extends Component<RoutesProps, State> {
    ...
    render() {
        ...
        return (
            <>
                    ...
                    <Header className={styles.header}>
                        ...
                        <Col xs={24} md={24} className='logoBox'>
                            <Button
                                ...
                                size={"large"}
                                onClick={() => {
                                    this.DrawerCateEl.toggleDrawer(true)
                                }}
                                className='menusBtn'
                            />
                ...
                <DrawerCate ref={el => { this.DrawerCateEl = el; }} />
                <UcenterModal />
            </>
        )
    }
    ...
    resize() {
        ...
        // 	})
        // }
        this.DrawerCateEl && this.DrawerCateEl.toggleDrawer(false)
    }
