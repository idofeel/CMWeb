...
lastTime=curTime;lastObjectIndex=objectIndex;lastX1=x1,lastY1=y1;pickObjectIndexs=glRunTime.getPickObjectIndexs();setPickObjectParameters();}
...
const ANIMRUN=0;const ANIMPAUSE=1;const ANIMEND=2;const ANIMTERMINAL=3;var animationClock=null;var animationStatus=ANIMTERMINAL;var uTotalFrame=0;var uCurFrame=0;var uSleepTime=40;function setAnimationStart(){uTotalFrame=glRunTime.getTotalFrame();isLockCavans=true;if(animationStatus==ANIMTERMINAL){setHome();}
